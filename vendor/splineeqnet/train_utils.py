...
def train(
    ...
    if model == "simlpe_dct":
        ...
        beta_matrix_min_rate_raw = config.get("twostage_beta_matrix_min_rate", 0.5)
        beta_matrix_max_rate_raw = config.get("twostage_beta_matrix_max_rate", 2.0)
        ...
        dhalf_gamma = float(config.get("twostage_dhalf_gamma", 1.0))
        learnable_dhalf = bool(config.get("twostage_learnable_dhalf", False))
